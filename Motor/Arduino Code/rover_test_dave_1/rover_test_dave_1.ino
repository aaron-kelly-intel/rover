...
BLEService writeService("de46a385-d410-4f00-8b8d-ec116984841c");
...
//  Serial.println(stepAmount);
  ...
  if (input[0] >= 1)
  {
    motorL->step(stepAmount, BACKWARD, DOUBLE);  // 1 step = 1.8degrees 
  }
  else if (input[0] <= -1)
  {
    motorL->step(stepAmount, FORWARD, DOUBLE);  // 1 step = 1.8degrees
  }
  else
  {
  ...
  if (input[1] >= 1)
  {
    motorR->step(stepAmount, FORWARD, DOUBLE);  // 1 step = 1.8degrees
  }
  else if (input[1] <= -1)
  {
    motorR->step(stepAmount, BACKWARD, DOUBLE);  // 1 step = 1.8degrees
  }
  else
  {
    delay(9);
